  ...
  <div class="l-breadcrumb" style="padding:20px;padding-bottom:0">
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Large-Size-Sofa</li>
      </ol>
    </nav>
  </div>
  <div class="l-product-fixation-1">
    <div class="row">
      <div class="col-md-6 " style="display:flex;flex-direction:column">
        <div class="">
          <img src="/images/sofa1.jpg" class="w-100 l-big-image" alt="" srcset="">
        </div>
        <div class="row" style="margin-top: 20px;">
          <div class="col-3" >
            <img src="/images/sofa1.jpg" class="w-100 l-small-image" alt="" srcset="">
          </div>
          <div class="col-3">
            <img src="/images/sofa2.jpg" class="w-100 l-small-image" alt="" srcset="">
          </div>
          <div class="col-3" >
            <img src="/images/sofa3.jpeg" class="w-100 l-small-image" alt="" srcset="">
          </div>
          <div class="col-3" >
            <img src="/images/sofa4.jpg" class="w-100 l-small-image" alt="" srcset="">
          </div>
          <div class="col-3" >
            <img src="/images/sofa4.jpg" class="w-100 l-small-image" alt="" srcset="">
          </div>
          ...
          <div class="additional-information " style="display: flex;flex-direction:column">
            ...
            <div class="row">
              <div class="col-3" style="padding-left: 25px;padding-top:10px">
                <span class="row l-additional-info-label">Material</span>
                <span class="row l-additional-info-label">Size</span>

              </div>
              <div class="col-8" style="padding-top:10px">
                <span class="row l-additional-info-label margin-30-res" style="color: black;">Wood</span>
                <span class="row l-additional-info-label margin-30-res" style="color: black;">25*25</span>
