    ...
    <div class="container-fluid l-main-container">
        <div class="row">
            <div class="col-md-6 l-md-remove" style="padding: 50px;">
                <img src="/advertiser/signup/mainImage.svg" class="w-100" alt="">
            </div>
            <div class="col-md-6">
                <form class="container-fluid" id="submitForm" method="POST" style="padding:20px;display:flex;flex-direction:column">
                    ...
                    <span class="l-font-3">Already Have An Account? <a class="l-font-4" href="/advertiser/login/">Login Here</a></span>
                </form>
            </div>
        </div>
    </div>
